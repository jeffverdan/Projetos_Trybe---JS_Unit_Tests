...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(
      createMenu({
        food: { coxinha: 2.5, salgado: 2.5 },
        drink: { cocaCola: 5.0, suco: 2.5 },
      }).fetchMenu(),
    ).toEqual({
      food: { coxinha: 2.5, salgado: 2.5 },
      drink: { cocaCola: 5.0, suco: 2.5 },
    ...
    // ```
    // Salvei em uma variavel para poder armazenar o resultado dos testes
    const teste05 = createMenu();
    teste05.order('coxinha');
    expect(teste05.consumption).toEqual(['coxinha']);
    ...
    teste8.order('coca-cola 2l');
    teste8.order('coxinha');
    expect(teste8.pay()).toEqual(15);
