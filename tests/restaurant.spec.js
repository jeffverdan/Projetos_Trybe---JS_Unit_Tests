...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    let createMenuSmall = createMenu();

    createMenuSmall.order('coxinha');
    expect(createMenuSmall.consumption).toEqual(['coxinha']);
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    // ```
    createMenuSmall.order('água');
    createMenuSmall.order('sopa');
    createMenuSmall.order('sashimi');
    expect(createMenuSmall.consumption).toEqual(['coxinha', 'água', 'sopa', 'sashimi']);
    // objetoRetornado.order("coxinha");
    ...
    // ```
    const createMenuSmall1 = createMenu();
    createMenuSmall1.order('coxinha');
    createMenuSmall1.order('água');
    createMenuSmall1.order('coxinha');
    expect(createMenuSmall.consumption).toEqual(['coxinha', 'água', 'coxinha']);
    ...
    // ```
    let createMenuSmall2 = createMenu({ food: { 'coxinha': 3.9, 'sopa': 9.9}, drink: { 'água': 3.9, 'cerveja': 6.9}});

    createMenuSmall2.order('coxinha');
    createMenuSmall2.order('água');
    createMenuSmall2.order('coxinha');
    expect(createMenuSmall.pay()).toBeCloseTo(12.87);
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
...
// OBS: tive que criar varios createMenuSmall1 e createMenuSmall pois na hora dos testes eles estavam puxando os valores inseridos um do outro.
