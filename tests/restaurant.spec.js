...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(objetoRetornadoVazio.fetchMenu).toBeInstanceOf(Function)
    ...
    // ```  
    const objetoRetornado3 = (createMenu({bolo: {}, cafe: {} }))
      expect(createMenu({bolo: {}, cafe: {} }).fetchMenu()).toEqual(objetoRetornado3.fetchMenu())
