...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    expect(Object.keys(createMenu({ food: {}, drink: {} }).fetchMenu())[0]).toBe('food');
    expect(Object.keys(createMenu({ food: {}, drink: {} }).fetchMenu())[1]).toBe('drink');
    ...
    // ```
    let create = createMenu({food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9}});
    let ord = create.order('coxinha');
    expect(create.consumption).toEqual(['coxinha']);
    ...
    // ```
    create = createMenu({food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9}});
    ord = create.order('coxinha');
    ord = create.order('agua');
    ord = create.order('sopa');
    ord = create.order('sashimi');
    expect(create.consumption).toEqual(['coxinha', 'agua', 'sopa', 'sashimi']);
    ...
    ord = create.order('agua');
    ord = create.order('coxinha');
    expect(create.consumption).toEqual(['coxinha', 'agua', 'coxinha']);
    ...
    ord = create.order('agua');
    ord = create.order('coxinha');
    expect(create.pay()).toBeCloseTo(12.87);
