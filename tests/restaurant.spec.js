...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    expect(createMenu({ food: { Picanha: 1.99, ContraFilé: 0.99 }, drink: { Vodka: 5.99, Whisky: 9.99 } }).fetchMenu()).toEqual({ food: { Picanha: 1.99, ContraFilé: 0.99 }, drink: { Vodka: 5.99, Whisky: 9.99 } });
