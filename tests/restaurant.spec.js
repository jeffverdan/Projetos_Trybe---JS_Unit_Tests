...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    let expectedAnswer = { food: {}, drink: {}}
    expect(objetoRetornado.fetchMenu()).toEqual(expectedAnswer); // Retorno: { food: {}, drink: {}}
    // ```
    ...
    expect(objetoRetornado.fetchMenu()).toEqual(myMenu);
    ...
    expectedArray = ['coxinha', 'agua', 'sopa', 'sashimi'];
    expect(objetoRetornado.consumption).toEqual(expectedArray);
    ...
    objetoRetornado = createMenu(myMenuTest2);
    objetoRetornado.consumption = [];
    objetoRetornado.order('coxinha');
    objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
