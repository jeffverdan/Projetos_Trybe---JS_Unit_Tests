...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    const chavesDoObjeto = Object.keys(objetoRetornado.fetchMenu())
    expect(chavesDoObjeto).toEqual(['food', 'drinks'])
    ...
    // ```
    expect(objetoRetornado.consuption).toEqual([]);
    ...
    // ```
    objetoRetornado.order('coxinha');
    expect(objetoRetornado.consuption).toEqual(['coxinha']);
    ...
    objetoRetornado.order("sopa");
    objetoRetornado.order("sashimi");
    expect(objetoRetornado.consuption).toEqual(['coxinha', 'agua', 'sopa', 'sashimi']);
    ...
    objetoRetornado.order("coxinha");
    objetoRetornado.order("agua");
    expect(objetoRetornado.consuption).toEqual(['coxinha', 'agua', 'sopa', 'sashimi', 'coxinha', 'agua'])
