...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => { 
    ...
    const chama = circle(2);
    // chama.perimetro = chama.radius * 5; 
    const contaPropriedades = Object.keys(chama).length;
    expect(contaPropriedades).toBe(3);
    ...
    expect(Object.values(circle(3))).toEqual(expect.arrayContaining(value));
  });
});
