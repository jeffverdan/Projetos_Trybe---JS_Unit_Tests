...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    let filhoUm = productDetails('Alcool gel', 'Máscara')[0]
    let filhoDois = productDetails('Alcool gel', 'Máscara')[1]
    expect(typeof filhoUm).toBe('object');
    expect(typeof filhoDois).toBe('object');
